...
test('несколько слушателей в одной строке — через запятую и «и»', () => {
  const base = TEMPLATE.replace('ФИО: Клоун Пеннивайз Убийца',
    'ФИО: Иванов Иван Иванович, Петров Пётр Петрович и Сидоров Сидор Сидорович');
  const r = parsePaymentRequest(base);
